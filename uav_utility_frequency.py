...
class StackelbergGame:
    ...
    # 平均成本曲线
    def figure_total_utility(self,total_utility,num_iters):
        plt.plot(np.arange(num_iters),total_utility)
        plt.show()
...
for k in range(10):
    ...
    for i in range(num):
        ...
        total_utility.append(sum_utility)
    print(total_utility[290:300])
    game.figure_total_utility(total_utility,num)
