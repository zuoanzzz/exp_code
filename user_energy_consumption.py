...
class StackelbergGame:
    ...
    # 服务器能耗图
    def figure_user_energy_consumption(self,uav_energy_consumption,num_iters):
    ...
    for i in range(num):
        ...
        for user_indexes in users_indexes:
            for j in range(user_number):
                sum_energy += user_indexes[i + j][2]
        energy_consumption.append(sum_energy)
    print(energy_consumption[290:300])
    game.figure_user_energy_consumption(energy_consumption,len(energy_consumption)+1)